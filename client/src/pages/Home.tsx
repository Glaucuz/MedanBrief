...
export default function Home() {
  ...
  const pagedSummaries = summaries ? summaries.slice((page - 1) * perPage, page * perPage) : [];
  const totalPages = summaries ? Math.max(1, Math.ceil(summaries.length / perPage)) : 1;
          ...
          <div className="container mx-auto px-4">
            ...
            {isLoading ? (
              ...
              <>
                ...
                {summaries && summaries.length > perPage && (
